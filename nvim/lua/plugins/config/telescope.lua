-- Telescope configuration for powerful fuzzy finding
-- Migrated and enhanced from user/telescope.lua
...
function M.setup()
  ...
  if not telescope or not actions then
    vim.notify("Telescope not available. Run :Lazy sync to install.", vim.log.levels.WARN)
    return
  end
...
M.can_open_telescope = can_open_telescope
